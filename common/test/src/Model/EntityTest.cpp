    ...
    namespace Model {
        ...
        TEST_CASE("EntityTest.setProperties") {
            SECTION("Updates cached model transformation") {
                ...
                auto definition = Assets::PointEntityDefinition{"some_name", Color{}, vm::bbox3{32.0}, "", {},
                    Assets::ModelDefinition{{EL::MapExpression{{
                        {"scale", {EL::VariableExpression{"modelscale"}, 0, 0}}
                    }}, 0, 0}}};
        ...
        TEST_CASE("EntityTest.setOrigin") {
            ...
            SECTION("Updates cached model transformation") {
                ...
                entity.setDefinition(config, &definition);
                REQUIRE(entity.modelTransformation() == vm::translation_matrix(vm::vec3{1, 2, 3}) * vm::scaling_matrix(vm::vec3{2, 2, 2}));
        ...
        TEST_CASE("EntityTest.transform") {
            ...
            auto otherDefinition = Assets::PointEntityDefinition{"some_class", Color{}, vm::bbox3{32.0}, "", {}, {}};
