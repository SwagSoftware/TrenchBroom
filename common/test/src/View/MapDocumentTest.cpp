...
namespace TrenchBroom {
    namespace View {
        ...
        TEST_CASE_METHOD(MapDocumentTest, "MapDocumentTest.selectTouching") {
            ...
            brush2->setBrush(brush2->brush().transform(document->worldBounds(), vm::translation_matrix(vm::vec3(10.0, 0.0, 0.0)), false).value());
            brush3->setBrush(brush3->brush().transform(document->worldBounds(), vm::translation_matrix(vm::vec3(100.0, 0.0, 0.0)), false).value());
        ...
        TEST_CASE_METHOD(MapDocumentTest, "MapDocumentTest.selectTall") {
            ...
            brush2->setBrush(brush2->brush().transform(document->worldBounds(), vm::translation_matrix(vm::vec3(0.0, 0.0, -500.0)), false).value());
            brush3->setBrush(brush3->brush().transform(document->worldBounds(), vm::translation_matrix(vm::vec3(100.0, 0.0, 0.0)), false).value());
