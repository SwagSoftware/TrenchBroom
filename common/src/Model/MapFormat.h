...
enum class MapFormat {
  ...
  Doom3,
  /**
   * Doom 3 with Valve 220 format texturing, supported by
   * https://github.com/RobertBeckebans/RBDOOM-3-BFG/tree/506-TrenchBroom-interop/neo/tools/compilers/dmap
   */
  Doom3_Valve,
};
